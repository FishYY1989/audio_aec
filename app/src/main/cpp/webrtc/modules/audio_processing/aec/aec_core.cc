...
#if defined(_MSC_VER) //VS2013 NOT support key word "constexpr" -- by Yaphet
...
// log{0.001, 0.00001, 0.00000001, 0.0000000000001, 0.00000000000000000001} //add last 2 by Yaphet
static const float kTargetSupp[5] = {-6.9f, -11.5f, -18.4f, -29.9f, -46.0f};

// Two sets of parameters, one for the extended filter mode.
static const float kExtendedMinOverDrive[5] = {3.0f, 6.0f, 15.0f, 30.0f, 60.0f}; //add last 2 by Yaphet
static const float kNormalMinOverDrive[5] = {1.0f, 2.0f, 5.0f, 10.0f, 20.0f}; //add last 2 by Yaphet
...
void WebRtcAec_SetConfigCore(AecCore* self,
                             ...
                             int metrics_mode,
                             int delay_logging) {
  assert(nlp_mode >= 0 && nlp_mode < 5); //change 3->5 by Yaphet
