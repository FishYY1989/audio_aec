...
private:
  void saveAudioDataToFile(TestFileWriter* file, AudioBuffer* audio);
  TestFileWriter* m_pFileAfterHP;
  TestFileWriter* m_pFileAfterNS;
  TestFileWriter* m_pFileAfterAGC;
  TestFileWriter* m_pFileAfterAEC;
  TestFileWriter* m_pFileAfterVAD;
};
